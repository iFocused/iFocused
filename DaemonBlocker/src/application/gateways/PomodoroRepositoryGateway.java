...
public interface PomodoroRepositoryGateway {
	/**
	 ...
	 */
	boolean populateUserData(PomodoroRepository pomodoroRepository);
	 ...
	 */
	boolean saveUserData(ArrayList<PomodoroSession> pomodoroSessions);
}
