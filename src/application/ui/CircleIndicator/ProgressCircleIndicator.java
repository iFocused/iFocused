...
abstract class ProgressCircleIndicator extends Control {
     ...
     */
    public void setProgress(double progressValue, String newLabel) {
    	label.set(newLabel);
    ...
    public void makeIndeterminate(String startingLabel) {
        setProgress(INDETERMINATE_PROGRESS, startingLabel);
    }
